...
enum RepoNames {
    ...
    NexusRelPubRepo([7432: 'Private_NRLSSCGEO_Releases']),
    NexusSnapPubRepo([7432: 'Private_NRLSSCGEO_Snapshots']),
    NexusYumPubRepo([7432: 'Private_NRLSSCGEO_Yum'])

    private Map<Integer, String> codeMap

    RepoNames(Map<Integer, String> codeMap)
    {
        this.codeMap = codeMap
    }

    String getName(int groupCode)
    {
